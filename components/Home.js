      ...
      <div className="w-full h-full relative z-[1] flex flex-col items-center justify-center page1-content">
        ...
        <div className="flex items-center justify-between absolute bottom-0 w-full px-[3vw] py-[2vw] footer-content">
          ...
          <div className="flex gap-[2vw] items-center footer-content-text">
            <h4 className="max-w-[16vw] font-light cursor-pointer hover:opacity-80 transition-opacity">Web Developer</h4>
            <h4 className="max-w-[16vw] font-light cursor-pointer hover:opacity-80 transition-opacity">Ui/UX Designer</h4>
            <h4 className="max-w-[16vw] font-light cursor-pointer hover:opacity-80 transition-opacity">Web Animator</h4>
          </div>
        </div>
      </div>
